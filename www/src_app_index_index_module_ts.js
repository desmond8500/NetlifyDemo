...
let IndexPage = class IndexPage {
    constructor(formBuilder, http) {
        ...
        this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__.FormGroup({
            ...
            objet: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__.FormControl()
        });
    }
    ngOnInit() {
    }
    submit() {
        ...
        this.http.post("http://127.0.0.1:8000/api/annonces", this.form.value)
            .subscribe(data => {
...
IndexPage = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-title>index</ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n  <form [formGroup]=\"form\" (ngSubmit)=\"submit()\">\n\n    <ion-item >\n      <ion-input formControlName='id' placeholder=\"id\" type=\"text\"></ion-input>\n    </ion-item>\n    <ion-item >\n      <ion-input formControlName='user_id' placeholder=\"user_id\" type=\"text\"></ion-input>\n    </ion-item>\n    <ion-item >\n      <ion-input formControlName='objet' placeholder=\"objet\" type=\"text\"></ion-input>\n    </ion-item>\n\n    <ion-button type=\"submit\" expand=\"block\" class=\"login_button\">VALIDER</ion-button>\n  </form>\n</ion-content>\n";
